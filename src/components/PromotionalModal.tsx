      ...
      <DialogContent className="p-0 border-none max-w-2xl">
        <div className="bg-[#FEF946] text-black">
          <div className="flex justify-end p-2">
            <button onClick={() => onOpenChange(false)} className="bg-[#333] text-white p-1 rounded-full hover:bg-black">
              <X size={20} />
            </button>
          </div>
          ...
          <div className="px-4 md:px-8 pb-8 flex flex-col items-center">
            ...
            <div className="text-center mt-6 space-y-4">
              ...
              <div className="mt-6">
                <a href="https://www.amazon.es/Workbook-para-Dise%C3%B1adores-producto-gr%C3%A1ficos/dp/B0DLTT5WNM" target="_blank" rel="noopener noreferrer" className="bg-black text-white font-mono py-3 px-8 inline-block hover:bg-opacity-80 transition-colors">
